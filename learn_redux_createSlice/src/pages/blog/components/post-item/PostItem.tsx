...
interface PostItemType {
  post: Post
  handleDelete: (idDelete: string) => void
  handleStartEditingPost: (idEdit: string) => void
}
  ...
  return (
    <div>
      <div className='flex flex-col items-center overflow-hidden rounded-lg border md:flex-row'>
        <div className='group relative block h-48 w-full shrink-0 self-start overflow-hidden bg-gray-100 md:h-[300px] md:w-32 lg:w-48'>
          <img
